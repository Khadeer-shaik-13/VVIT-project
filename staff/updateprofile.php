...
<form method="POST" enctype="multipart/form-data">
  ...
  <td colspan="2"><?php echo @$err; ?></td>
   ...
   <tr>
   <th width="237" scope="row"><font color="blue">Select Department</font></th>
    <td width="213">
...
<?php 	}
    ...
    <tr>
    <th width="237" scope="row"><font color="blue">Semester Name</font> </th>
    <td width="213">
