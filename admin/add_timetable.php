...
<?php 
  ...
  if($_GET['generated']){
    ...
    if($weekTimeTable){
      ...
      <th class='text-center'>Lecture 1<br>08:20-09:15</th>
      <th class='text-center'>Lecture 2<br>09:15-10:10</th>
      <th class='text-center'>Break<br>10:10-10:20</th>
      <th class='text-center'>Lecture 3<br>10:20-11:15</th>
      <th class='text-center'>Lecture 4<br>11:15-12:10</th>
      <th class='text-center'>Break<br>12:10-12:50</th>
      <th class='text-center'>Lecture 5<br>12:50-1:45</th>
      <th class='text-center'>Lecture 6<br>1:45-2:45</th>";
      ...
      for($i = 0; $i < 6; $i++){
        ...
        for($j = 0; $j < 6; $j++){
            ...
            if($j === 1){
              echo "<th class=' text-center'><b style='text-sze=24'>".$break[$i]."</b></th>";
            }
            if($j === 3){
